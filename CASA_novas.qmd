...
Inside Airbnb collected data to uncover the impact of short-term lets (STL) on residential communities, which may be hidden by Airbnb’s PR-driven data. In 2015, Airbnb purged over 1,000 listings from multiple-listing hosts just before taking a manipulated snapshot for its ‘transparency initiative’ [@cox_how_2020]. Without this exposure, Airbnb’s negative impact on local housing markets would have been underestimated. As a grassroots initiative, Inside Airbnb aims to resist dominant corporate narratives. With more transparent data, the accountability of Airbnb in gentrification, eviction, and the housing crisis can be revealed. This data supports researchers, policymakers, and marginalized communities in advocating for fairer STL regulations and social justice—an example of data for co-liberation [@dignazio_data_2020].
