...
def download_bib_file(url, out_path):
...
download_bib_file("https://github.com/hanxiang270/CASA_novas/blob/bacb80b4ed95209dc918ec88be19cdcd2c6f8402/CASA_novas_bib.bib", "CASA_novas_bib.bib")

download_bib_file("https://github.com/hanxiang270/CASA_novas/blob/bacb80b4ed95209dc918ec88be19cdcd2c6f8402/harvard-cite-them-right.csl", "harvard-cite-them-right.csl")
```
...
boros.to_csv('boros_data.csv', index=False)

print("Datos exportados como 'boros_data.csv'.")
```
...
>>>>>>> c33e7174eba25eb1cdba96a07009978e66234374
:::
